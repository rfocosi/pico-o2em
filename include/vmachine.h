...
// Optimized MAXLINES to support PAL (312 lines) while saving RAM
#define MAXLINES 312
#define MAXSNAP 5
...
// RAM Optimization: Reduced bank count from 8 to 4 (saving 16 KB)
extern uint8_t rom_table[4][4096];
